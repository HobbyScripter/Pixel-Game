package de.game.world;

import org.lwjgl.opengl.GL11;

import de.game.chunk.Chunk;
import de.game.chunk.Tile;
import de.game.entity.Player;
import de.game.physics.AABB;
import de.game.physics.HitResult;
import de.game.physics.Tesselator;

public class LevelRenderer {
	  private static final int CHUNK_SIZE = 16;
	private static final LevelListener LevelListener = null;
	  ...
	  public LevelRenderer(Level levelg)
	  {
	    level = levelg;
	    level.addListener(this.LevelListener);
